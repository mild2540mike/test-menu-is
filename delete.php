<?php
    ...
    if(isset($_POST['deletedata'])) {
        ...
        if(!empty($_POST['menu_ID'])){
                ...
                if($result) {
                    $_SESSION['prompt'] = "ลบข้อมูลสำเร็จ";
        ...
        <?php
            ...
            <div class="card">
                <div class="card-header">
                    <h4><a href="index.php" style="color:black;">ลบรายการอาหาร</a></h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" >
                        ...
                        <button type="submit" class="btn btn-danger" name="deletedata">ลบข้อมูล</button>
